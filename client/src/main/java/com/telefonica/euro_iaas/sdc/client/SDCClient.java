...
public class SDCClient {
	 ...
	 */
	public ProductInstanceService getProductInstanceService(String baseUrl,
			String mediaType) {
	 ...
	 * @param waitingPeriod
	 *            the period of time in ms between retries to get the complete
	 *            task (this period will increase this way t = n*waitingPeriod)
	 * @return the TaskService
	 */
	public TaskService getTaskService(String baseUrl, String mediaType,
			Long maxWaiting, Long waitingPeriod) {
		return new TaskServiceImpl(client, baseUrl, mediaType, waitingPeriod,
				maxWaiting);
	}
	...
	public ProductInstanceSyncService getProductInstanceSyncService(
			String baseUrl, String mediaType) {
		return new ProductInstanceSyncServiceImpl(getProductInstanceService(
				baseUrl, mediaType), getTaskService(baseUrl, mediaType));
	}
	 ...
	 */
	public ProductInstanceSyncService getProductInstanceSyncService(
			String baseUrl, String mediaType, Long maxWaiting,
			Long waitingPeriod) {
		return new ProductInstanceSyncServiceImpl(getProductInstanceService(
				baseUrl, mediaType), getTaskService(baseUrl, mediaType,
				maxWaiting, waitingPeriod));
	}
	...
	/**
	 * Get the service to work with products and product releases in the
	 * catalog.
	 * 
	 * @param baseUrl
	...
	/**
	 * Get the service to work with applications and application releases in the
	 * catalog.
	 * 
	 * @param baseUrl
	 ...
	 * @return the service.
	 */
	public ApplicationService getApplicationService(String baseUrl,
			String mediaType) {
	 ...
	 * @return the service.
	 */
	public EnvironmentService getEnvironmentService(String baseUrl,
			String mediaType) {
	 ...
	 * @return the service.
	 */
	public ChefNodeService getChefNodeService(String baseUrl,
			String mediaType) {
	 ...
	 * @return the service.
	 */
	public ChefClientService getChefClientService(String baseUrl,
			String mediaType) {
