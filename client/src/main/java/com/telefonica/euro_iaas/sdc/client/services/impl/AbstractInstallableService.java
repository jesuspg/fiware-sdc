...
public abstract class AbstractInstallableService extends AbstractBaseService {
    ...
    /**
     * See {@link ApplicationInstanceService#upgrade(String, Long, String, String)}
     *  or {@link ProductInstanceService#upgrade(String, Long, String, String)}
     */
    public Task upgrade(String vdc, Long id, String version, String callback) {
        String url = getBaseHost() + MessageFormat.format(
                upgradePath, vdc, id, version);
    ...
    /**
     * See {@link ApplicationInstanceService#configure(String, Long, String, Attributes)}
     *  or {@link ProductInstanceService#configure(String, Long, String, Attributes)}
     */
    public Task configure(String vdc, Long id, String callback,
    ...
    /**
     * See {@link ApplicationInstanceService#uninstall(String, Long, String)}
     *  or {@link ProductInstanceService#uninstall(String, Long, String)}
     */
    public Task uninstall(String vdc, Long id, String callback) {
        String url = getBaseHost() + MessageFormat.format(
                uninstallPath, vdc, id);
        WebResource wr = getClient().resource(url);
        Builder builder = wr.accept(getType());
        builder = addCallback(builder, callback);
    ...
    /**
     * @param upgradePath the upgradePath to set
     */
    ...
    /**
     * @param uninstallPath the uninstallPath to set
     */
