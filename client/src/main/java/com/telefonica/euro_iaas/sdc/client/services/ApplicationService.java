...
public interface ApplicationService {
	 ...
	 */
	ApplicationRelease add(ApplicationReleaseDto releaseDto,
	 ...
	 * @return the created application.
	 */
	ApplicationRelease update(ApplicationReleaseDto releaseDto,
			InputStream cookbook, InputStream files);
	 ...
	 */
	List<ApplicationRelease> findAll(Integer page, Integer pageSize,
