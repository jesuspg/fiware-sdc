...
public interface ApplicationService {
     ...
     */
    ApplicationRelease add(ApplicationReleaseDto releaseDto, InputStream cookbook, InputStream files);
     ...
     * @return the created application.
     */
    ApplicationRelease update(ApplicationReleaseDto releaseDto, InputStream cookbook, InputStream files);
     ...
     *             if the selected application does not exists.
     */
    ApplicationRelease load(String application, String version) throws ResourceNotFoundException;
     ...
     */
    List<ApplicationRelease> findAll(Integer page, Integer pageSize, String orderBy, String orderType,
