...
public interface ApplicationInstanceService extends BaseInstallableService<ApplicationInstance> {
     ...
     */
    Task install(String vdc, ApplicationInstanceDto application, String callback);
