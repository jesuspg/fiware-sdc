...
public class ApplicationInstanceServiceImpl extends AbstractInstallableService
	...
	public Task install(String vdc, ApplicationInstanceDto application,
		...
		Builder builder = wr.accept(getType()).type(getType()).entity(
				application);
	...
	public List<ApplicationInstance> findAll(String hostname, String domain,
		...
		searchParams = addParam(searchParams, "applicationName",
				applicationName);
	...
	public ApplicationInstance load(String vdc, String name) {
		String url = getBaseHost()
				+ MessageFormat.format(
						ClientConstants.APPLICATION_INSTANCE_PATH, vdc, name);
