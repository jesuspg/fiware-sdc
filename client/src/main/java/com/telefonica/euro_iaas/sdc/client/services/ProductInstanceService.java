...
public interface ProductInstanceService extends
		BaseInstallableService<ProductInstance> {
	...
	Task installArtifact(String vdc, String productInstanceId,
			Artifact artefact, String callback);
	
	Task uninstallArtifact(String vdc, String productInstanceId,
			Artifact artefact, String callback);
