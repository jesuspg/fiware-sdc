...
public interface BaseInstallableSyncService<T extends InstallableInstance> {
	 ...
	 * @param new version the new version to upgrade to async operation will be
	 *        sent
	 * 
	 * @return the task
	 ...
	 * 
	 */
	T upgrade(String vdc, String name, String version)
	...
	T configure(String vdc, String name, List<Attribute> arguments)
			throws MaxTimeWaitingExceedException, InvalidExecutionException;
	...
	T uninstall(String vdc, String name) throws MaxTimeWaitingExceedException,
