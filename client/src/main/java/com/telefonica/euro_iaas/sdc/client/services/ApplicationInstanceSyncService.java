...
/**
 * Provides the operations to work with application instances in a
 *  synchronous mode
 * @author Sergio Arroyo
 *
 */
public interface ApplicationInstanceSyncService
        extends BaseInstallableSyncService<ApplicationInstance>{
         ...
         *             installed
         * @throws MaxTimeWaitingExceedException if the operation spend more
         * time that is allowed
         * @throws InvalidExecutionException if the return of the task is not success
         */
         ...
         * @param vdc the vdc where the application is installed
        ...
        List<ApplicationInstance> findAll(Integer page, Integer pageSize,
                ...
                String vdc, String applicationNAme);
