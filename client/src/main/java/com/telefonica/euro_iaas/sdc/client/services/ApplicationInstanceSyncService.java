 ...
 */
public interface ApplicationInstanceSyncService extends BaseInstallableSyncService<ApplicationInstance> {
     ...
     */
    ApplicationInstance install(String vdc, ApplicationInstanceDto application) throws MaxTimeWaitingExceedException,
     ...
     */
    List<ApplicationInstance> findAll(String hostname, String domain, String ip, String fqn, Integer page,
