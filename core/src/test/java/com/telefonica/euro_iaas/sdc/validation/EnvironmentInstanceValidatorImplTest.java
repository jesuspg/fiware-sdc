...
public class EnvironmentInstanceValidatorImplTest {
    ...
    private ProductRelease pRelease1 = new ProductRelease("1", "releaseNotes", null, product, null, null);
    private ProductRelease pRelease2 = new ProductRelease("2", "releaseNotes", null, product, null, null);
    List<ProductRelease> productReleasesInstalled = Arrays.asList(pRelease1, pRelease2);
    ...
    private ProductInstance pInstance = new ProductInstance(pRelease1, Status.INSTALLED, new VM("ip"), "vdc");
    private ProductInstance pInstanceUninstalled = new ProductInstance(pRelease1, Status.UNINSTALLED, new VM("ip"),
            "vdc");
    private ProductInstance pInstance2 = new ProductInstance(pRelease2, Status.INSTALLED, new VM("ip"), "vdc");

    private List<ProductInstance> piInstalled = Arrays.asList(pInstance, pInstance2);
    private List<ProductInstance> piUnInstalled = Arrays.asList(pInstanceUninstalled);

    private EnvironmentInstance envInstanceInstalled = new EnvironmentInstance(envInstalled, piInstalled);
    private EnvironmentInstance envInstanceUnInstalled = new EnvironmentInstance(envUnInstalled, piUnInstalled);

    private Application app = new Application("app", "description", "type");

    private ApplicationRelease release1 = new ApplicationRelease("1", "releaseNotes", null, app, new Environment(
            Arrays.asList(pRelease1)), new ArrayList<ApplicationRelease>());
    private ApplicationRelease release2 = new ApplicationRelease("2", "releaseNotes", null, app, new Environment(
    ...
    public void prepareMocks() throws Exception {
        ...
        List<ApplicationInstance> applicationInstances = Arrays.asList(application);
    ...
    public void testValidateUpdateShouldThrowsInvalidEnvironmentInstanceException() throws Exception {
    ...
    public void testValidateDeleteShouldThrowsInvalidEnvironmentInstanceException() throws Exception {
