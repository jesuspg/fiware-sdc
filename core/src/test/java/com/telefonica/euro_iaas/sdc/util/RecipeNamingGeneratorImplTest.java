...
public class RecipeNamingGeneratorImplTest {
    ...
    private final static String INSTALL_PRODUCT_RECIPE_TEMPLATE =
        "{0}::{1}_install";
    private final static String INSTALL_APPLICATION_RECIPE_TEMPLATE =
        "{0}::{1}-{2}_install_{3}";
    ...
    private final static String INSTALL_APPLICATION_RECIPE =
        "war::sdc-1.0.0_install_postgresql-8.4_tomcat-6";


    /**
     * This test will receive the installation template and will return the
     * installation template filled with the correct values.
     * @throws Exception
     */
    @Test
