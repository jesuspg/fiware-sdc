...
public class ApplicationInstanceValidatorImplTest {
    ...
    public void testValidateInstallShouldBeOk() throws Exception {
        ApplicationInstanceValidatorImpl validator = new ApplicationInstanceValidatorImpl();
        ...
        application
                .setEnvironmentInstance(new EnvironmentInstance(release1.getEnvironment(), Arrays.asList(pInstance)));
    ...
    public void testValidateInstallShouldThrowsNotInstalledProductException() throws Exception {
        ...
        application.setEnvironmentInstance(new EnvironmentInstance(release1.getEnvironment(), Arrays
    ...
    public void testValidateInstallShouldThrowsIncompatibleProductException() throws Exception {
        ...
        application.setStatus(Status.INSTALLED);
        application
                .setEnvironmentInstance(new EnvironmentInstance(release2.getEnvironment(), Arrays.asList(pInstance2)));
        validator.validateInstall(application);
    }
    ...
    public void testValidateUpgrade() throws Exception {
        ...
        application.setStatus(Status.INSTALLED);
        application
                .setEnvironmentInstance(new EnvironmentInstance(release2.getEnvironment(), Arrays.asList(pInstance)));
