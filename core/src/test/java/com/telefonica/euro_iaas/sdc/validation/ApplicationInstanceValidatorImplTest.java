...
public class ApplicationInstanceValidatorImplTest {
	...
	public void testValidateInstallShouldBeOk() throws Exception {
		...
		application.setEnvironmentInstance(new EnvironmentInstance(release1
				.getEnvironment(), Arrays.asList(pInstance)));
	...
	public void testValidateInstallShouldThrowsNotInstalledProductException()
			throws Exception {
		ApplicationInstanceValidatorImpl validator = new ApplicationInstanceValidatorImpl();
		validator.setFsmValidator(fsmValidator);
		...
		application.setEnvironmentInstance(new EnvironmentInstance(release1
				.getEnvironment(), Arrays.asList(pInstanceUninstalled)));
		validator.validateInstall(application);
	}

	@Test(expected = IncompatibleProductsException.class)
	public void testValidateInstallShouldThrowsIncompatibleProductException()
			throws Exception {
		ApplicationInstanceValidatorImpl validator = new ApplicationInstanceValidatorImpl();
		validator.setFsmValidator(fsmValidator);
		ApplicationInstance application = new ApplicationInstance();
		application.setApplication(release1);
		application.setStatus(Status.INSTALLED);
		application.setEnvironmentInstance(new EnvironmentInstance(release2
				.getEnvironment(), Arrays.asList(pInstance2)));
		validator.validateInstall(application);
	}
	...
	public void testValidateUpgradeShouldThrowsNotDefinedTransitionException()
			throws Exception {
		ApplicationInstanceValidatorImpl validator = new ApplicationInstanceValidatorImpl();
		validator.setFsmValidator(fsmValidator);
		ApplicationInstance application = new ApplicationInstance(2l);
	...
	@Test(expected = IncompatibleProductsException.class)
	public void testValidateUpgradeShouldThrowsIncompatibleProductsException()
			throws Exception {
		ApplicationInstanceValidatorImpl validator = new ApplicationInstanceValidatorImpl();
		validator.setFsmValidator(fsmValidator);
		ApplicationInstance application = new ApplicationInstance(2l);
