...
public class ApplicationInstanceDaoJpaImplTest extends AbstractJpaDaoTest {
    ...
    public void createElements() throws Exception {
        ...
        EnvironmentInstance envInstancet6 = new EnvironmentInstance(tomcat6Env, Arrays.asList(tomcat6Instance));
        envInstancet6 = environmentInstanceDao.create(envInstancet6);

        EnvironmentInstance envInstancet7 = new EnvironmentInstance(tomcat7Env, Arrays.asList(tomcat7Instance));
    ...
    public void testFindByProduct() throws Exception {
        ...
        criteria.setProduct(sdc040Instance.getEnvironmentInstance().getProductInstances().iterator().next());
