...
public class BaseInstallableInstanceManager {
    ...
    public void assignRecipes(VM vm, String recipe)
        ...
        // tell Chef the assigned recipes shall be installed:
        ChefNode node = chefNodeDao.loadNode(vm);
     ...
     * @param vm the chef node
     * @param attributes the new attributes
     * @param recipe the recipe for that new attributes
     */
    public void configureNode(VM vm, List<Attribute> attributes,
            String process, String recipe)
        throws CanNotCallChefException {
        // tell Chef the assigned recipes shall be deleted:
        ChefNode node = chefNodeDao.loadNode(vm);
        node.addRecipe(recipe);
     ...
     */
    public void setRecipeNamingGenerator(
            RecipeNamingGenerator recipeNamingGenerator) {
        this.recipeNamingGenerator = recipeNamingGenerator;
    }

    /**
     * @param chefNodeDao the chefNodeDao to set
     */
