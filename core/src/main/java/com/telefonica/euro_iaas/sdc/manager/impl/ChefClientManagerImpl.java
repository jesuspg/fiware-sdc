...
public class ChefClientManagerImpl implements ChefClientManager {
	...
	public ChefClient chefClientfindByHostname(String hostname) 
		...
		try {
			...
			String message = " An error ocurred invoing the Chef server to load " +
					"ChefClient whose hostname is  " + hostname;
			log.info(message);
	 ...
	 */
	public ChefClient chefClientload(String chefClientName)
	 ...
	 */
	public void chefClientDelete(String vdc, String chefClientName)
		...
		try {
			...
			String errorMsg = "The hostname " + hostname
					+ " does not have products installed " + enfe.getMessage();
			log.info(errorMsg);
		} catch (CanNotCallChefException e) {
			String errorMsg = "Error deleting the Node" + chefClientName
