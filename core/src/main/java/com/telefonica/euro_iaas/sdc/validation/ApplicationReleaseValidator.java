...
public interface ApplicationReleaseValidator {
	 ...
	 *             if the product Release on which the Application Release is
	 *             installed on exists in the system
	 */
	 ...
	 *             if the application Realease to be deleted is still installed
	 *             on some vms
	 */
