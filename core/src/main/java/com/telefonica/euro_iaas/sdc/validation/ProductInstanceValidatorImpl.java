...
public class ProductInstanceValidatorImpl implements ProductInstanceValidator {
    ...
    public void validateUninstall(ProductInstance product)
        ...
        List<ApplicationInstance> applications =
                getApplicationsByProduct(product);
    ...
    public void validateUpdate(ProductInstance product,
        ...
        List<ProductRelease> productReleases = product.getProduct()
        ...
        List<ApplicationInstance> applications =
                getApplicationsByProduct(product);
        List<ApplicationInstance> unsuportedApplications =
        ...
        if (!unsuportedApplications.isEmpty()) {
            throw new ApplicationIncompatibleException(
                    unsuportedApplications, newRelease);
        }
    }
