...
public class EnvironmentInstanceManagerImpl implements EnvironmentInstanceManager {
    ...
    @Override
    public EnvironmentInstance load(Long id) throws EnvironmentInstanceNotFoundException {
        try {
            return environmentInstanceDao.load(id);
        } catch (EntityNotFoundException e) {
            String environmentInstanceNotFoundException = " The Environment Instance" + id + " DOES NOT EXIST ";
    ...
    @Override
    public EnvironmentInstance insert(EnvironmentInstance environmentInstance) throws EnvironmentNotFoundException,
    ...
    @Override
    public void delete(Long Id) throws EnvironmentInstanceNotFoundException, ApplicationInstanceStillInstalledException {
    ...
    public EnvironmentInstance update(EnvironmentInstance environmentInstance)
            throws EnvironmentInstanceNotFoundException, EnvironmentNotFoundException,
            ProductInstanceNotFoundException, InvalidEnvironmentInstanceException {
    ...
    private EnvironmentInstance insertEnvironmentInstanceBBDD(EnvironmentInstance environmentInstance)
            throws EnvironmentNotFoundException, ProductInstanceNotFoundException, InvalidEnvironmentInstanceException,
            AlreadyExistsEnvironmentInstanceException {
        ...
        try {
            ...
            String environmentNotFoundException = "The Environment " + environment.getName() + " NOT FOUND ";
        ...
        for (int i = 0; i < productInstances.size(); i++) {
            ...
            try {
                ...
                String productInstanceNotFoundException = " The Product Instance"
                        + pInstance.getProductRelease().getProduct().getName() + "with id " + pInstance.getId()
                        + "  DOES NOT EXIST ";
        ...
        // EnvironmentInstance
        EnvironmentInstance environmentInstanceIn = new EnvironmentInstance(environmentEnv, productInstancesEnvironment);
        try {
            ...
            try {
                ...
                String alreadyExistsEnvironmentInstanceException = " The Environment "
                        + environmentInstanceIn.getEnvironment().getName() + "with ID " + environmentInstanceIn.getId()
                        + " ALREADY EXISTS ";
    ...
    private EnvironmentInstance updateEnvironmentInstanceBBDD(EnvironmentInstance environmentInstance)
            throws EnvironmentInstanceNotFoundException, ProductInstanceNotFoundException, EnvironmentNotFoundException {
        ...
        LOGGER.log(Level.INFO, "Environment Instance Before Loading " + environmentInstance.getEnvironment().getName()
                + " with ID " + environmentInstance.getId());
        // Environment
        try {
            environment = environmentDao.load(environmentInstance.getEnvironment().getName());
        } catch (EntityNotFoundException e) {
            String environmentNotFoundException = "The Environment " + environmentInstance.getEnvironment().getName()
                    + " NOT FOUND ";
            LOGGER.log(Level.SEVERE, environmentNotFoundException);
            throw new EnvironmentNotFoundException(environmentNotFoundException);
        }
        ...
        try {
            ...
            String InvalidEnvironmentInstanceNotFoundException = " The Environment Instance"
                    + environmentInstance.getEnvironment().getName() + " with ID " + environmentInstance.getId()
                    + " IS NOT VALID ";
    ...
    private void deleteEnvironmentInstanceBBDD(Long Id) throws EnvironmentInstanceNotFoundException,
        ...
        try {
            ...
            String environmentIntanceNotFoundException = " The Environment Instance" + Id + " DOES NOT EXIST ";
