 ...
 */
public class ApplicationInstanceDaoJpaImpl extends AbstractInstallableInstanceDaoJpaIml<ApplicationInstance, Long>
    ...
    public List<ApplicationInstance> findByCriteria(ApplicationInstanceSearchCriteria criteria) {
        ...
        if (!StringUtils.isEmpty(criteria.getApplicationName())) {
            baseCriteria.createAlias("application", "rls").createAlias("rls.application", "app");
            baseCriteria.add(Restrictions.eq("app.name", criteria.getApplicationName()));
        }
        ...
        List<ApplicationInstance> applications = setOptionalPagination(criteria, baseCriteria).list();
    ...
    @Override
    public ApplicationInstance findUniqueByCriteria(ApplicationInstanceSearchCriteria criteria)
     ...
     * @return
     */
    private List<ApplicationInstance> filterByProduct(List<ApplicationInstance> applications, ProductInstance product) {
