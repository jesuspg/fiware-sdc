...
public class ApplicationInstalledException extends Exception {
     ...
     * @param product
     */
    public ApplicationInstalledException(List<ApplicationInstance> applications, ProductInstance product) {
        super("The product " + product.getProductRelease().getProduct().getName() + "has " + applications.size()
