...
public interface EnvironmentInstanceManager {
     ...
     * @param id the environment instance identifier
     ...
     */
    EnvironmentInstance insert(EnvironmentInstance environmentInstance) throws 
     ...
     * @param EnvironmentInstance identifier
