...
/**
 * Defines the operations the system shall be able to do with Environment
 * Instance.
 * 
...
public interface EnvironmentInstanceManager {
	 ...
	 */
	EnvironmentInstance insert(EnvironmentInstance environmentInstance)
			throws EnvironmentNotFoundException,
	 ...
	 */
	void delete(Long Id) throws EnvironmentInstanceNotFoundException,
	 ...
	 * */
	EnvironmentInstance update(EnvironmentInstance environmentInstance)
			throws EnvironmentInstanceNotFoundException,
