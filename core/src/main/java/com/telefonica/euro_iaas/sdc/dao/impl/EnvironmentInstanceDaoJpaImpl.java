...
AbstractInstallableInstanceDaoJpaIml<EnvironmentInstance, Long> implements
    ...
    public List<EnvironmentInstance> findByCriteria(
        ...
        if (criteria.getEnvironment() != null) {
            baseCriteria.add(Restrictions.eq(
                    "environment", criteria.getEnvironment()));
        }
        
        List<EnvironmentInstance> applications = setOptionalPagination(
    ...
    @Override
    public EnvironmentInstance findUniqueByCriteria(
    		EnvironmentInstanceSearchCriteria criteria)
     ...
     * @return
     */
    private List<EnvironmentInstance> filterByProduct(
            List<EnvironmentInstance> environments, ProductInstance productInstance) {
