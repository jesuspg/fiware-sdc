...
public class ArtifactSearchCriteria extends AbstractSearchCriteria {
	...
	private String vdc;
	/**
	 * The status of the application (<i>this criteria return a list of
	 * entities<i>).
	 */
	...
	public ArtifactSearchCriteria(String orderBy, String orderType,
			Status status, ProductInstance productInstance, String vdc) {
	...
	public String toString() {
		return "ArtifactSearchCriteria [ status=" + status + ", product="
				+ productInstance + ", artifactName=" + artifactName + "]";
	}
