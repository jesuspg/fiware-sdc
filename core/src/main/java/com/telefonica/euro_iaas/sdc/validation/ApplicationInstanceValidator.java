...
public interface ApplicationInstanceValidator {
     ...
     * @param application the application
     * @throws FSMViolationException if the application is in status which is not
     * configure to uninstalled.
     */
     ...
     * @throws IncompatibleProductsException if the products where the application
     * is installed, are incompatible with the new version
     * @throws NotTransitableException if the application can not be update to the
     * new version
     * @throws FSMViolationException if the application is in status which is not
