...
public class NodeCommandSearchCriteria extends AbstractSearchCriteria {
     ...
     * @param os
     */
    public NodeCommandSearchCriteria(Integer page, Integer pageSize,
            String orderBy, String orderType, OS os) {
     ...
     * @param os
     */
    public NodeCommandSearchCriteria(String orderBy, String orderType,
            OS os) {
