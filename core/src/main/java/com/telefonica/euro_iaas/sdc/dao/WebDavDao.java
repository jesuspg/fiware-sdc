...
public interface WebDavDao {
     ...
     * @param the webdavDirectoryUrl to be created
     * @return void
     */
     ...
     * @param the file to be uploaded to the webdav
     * @return the file deleted
     */
    String insertFile(String webdavDirectory, File installable) 
    	throws SardineException;
    
    /**
     * Delete the Resource specified vi webdavUrl.
     * @param the URL of the resource to be deleted in webdav 
     ...
     * @param the DirectoryBase to check if a directory exists
     * @param the directory to be searched
     * @return boolean.
     */
    boolean directoryExists (String directoryBase, String webdavUrl)
    throws SardineException;
}
