...
public class StringReplaceUtils {
     ...
     * <code>&lt;argument.key&gt;</code> with
     * <code>argument.value</code>
     * @param target the string with the placeholders
     ...
     * @param target the string with the placeholders
     * @param arguments the values to replace
     * @param leftLimiter the string that limits the placeholder by left
     * @param rightLimiter the string that limits the placeholder by right
     * @return the string with the updated values.
     */
    public static String replace(String target, Map<String, String> arguments,
