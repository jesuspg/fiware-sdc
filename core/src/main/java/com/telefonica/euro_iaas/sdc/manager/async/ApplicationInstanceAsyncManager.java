...
public interface ApplicationInstanceAsyncManager {
     ...
     */
    void install(VM vm, String vdc, EnvironmentInstance environmentInstance, ApplicationRelease application,
     ...
     *            the installed application to configure
     * @param configuration
     *            the configuration parameters.
     * @param task
     *            the task which contains the information about the async execution
     ...
     *            if not empty, contains the url where the result of the execution will be sent
     */
    void configure(ApplicationInstance applicationInstance, List<Attribute> configuration, Task task, String callback);

    /**
     * Upgrade a ApplicationInstance
     * 
     * @param applicationInstance
     *            the installed application to upgrade
     * @param applicationRelease
     *            the applicationRelease to upgrade to.
     * @param task
     *            the task which contains the information about the async execution
     * @param callback
     *            if not empty, contains the url where the result of the execution will be sent
     */
    void upgrade(ApplicationInstance applicationInstance, ApplicationRelease applicationRelease, Task task,
            String callback);
