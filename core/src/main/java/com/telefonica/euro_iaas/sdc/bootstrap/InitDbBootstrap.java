	...
	public void contextInitialized(ServletContextEvent event) {
		...
		try {
			...
			try {
				...
				NodeCommand nodeCommandso11 = new NodeCommand(so1,
						"chefclient_command", "chef-client");
				nodeCommandso11 = nodeCommandDao.create(nodeCommandso11);
				NodeCommand nodeCommandso12 = new NodeCommand(so1,
						"hostname_command", "hostname");
				nodeCommandso12 = nodeCommandDao.create(nodeCommandso12);
				NodeCommand nodeCommandso13 = new NodeCommand(so1,
						"domain_command", "dnsdomainname");
				nodeCommandso13 = nodeCommandDao.create(nodeCommandso13);
				NodeCommand nodeCommandso14 = new NodeCommand(so1,
						"ipaddress_command", "hostname -I");
				nodeCommandso14 = nodeCommandDao.create(nodeCommandso14);
				NodeCommand nodeCommandso21 = new NodeCommand(so2,
						"chefclient_command", "chef-client");
				nodeCommandso21 = nodeCommandDao.create(nodeCommandso21);
				NodeCommand nodeCommandso22 = new NodeCommand(so2,
						"hostname_command", "hostname");
				nodeCommandso22 = nodeCommandDao.create(nodeCommandso22);
				NodeCommand nodeCommandso23 = new NodeCommand(so2,
						"domain_command", "dnsdomainname");
				nodeCommandso23 = nodeCommandDao.create(nodeCommandso23);
				NodeCommand nodeCommandso24 = new NodeCommand(so2,
						"ipaddress_command", "hostname -I");
				nodeCommandso24 = nodeCommandDao.create(nodeCommandso24);
				//CentOS
				NodeCommand nodeCommandso31 = new NodeCommand(so3,
						"chefclient_command", "chef-client");
				nodeCommandso31 = nodeCommandDao.create(nodeCommandso31);
				NodeCommand nodeCommandso32 = new NodeCommand(so3,
						"hostname_command", "hostname");
				nodeCommandso32 = nodeCommandDao.create(nodeCommandso32);
				NodeCommand nodeCommandso33 = new NodeCommand(so3,
						"domain_command", "dnsdomainname");
				nodeCommandso33 = nodeCommandDao.create(nodeCommandso33);
				NodeCommand nodeCommandso34 = new NodeCommand(so3,
						"ipaddress_command", "hostname -I");
				...
				ProductRelease tomcat7 = new ProductRelease("6",
						"Tomcat server 6", null, tomcat, supportedSSOO123, null);
				tomcat7 = productReleaseDao.create(tomcat7);
				
				Product nodejs = new Product("nodejs", "nodejs");
				nodejs = productDao.create(nodejs);
				nodejs.addAttribute(new Attribute("aux", "aux",
						"aux"));
				ProductRelease nodejsr = new ProductRelease("0.6.15",
						"Nodejs 0.6.15", null, nodejs, supportedSSOO123, null);
				...
				ProductRelease git17 = new ProductRelease("1.7",
						"git 1.7", null, git, supportedSSOO123, null);
				...
				ProductRelease mongoshard223 = new ProductRelease("2.2.3",
						"mongodb shard 2.2.3", null, mongoshard, supportedSSOO123, null);
				...
				ProductRelease mongos223 = new ProductRelease("2.2.3",
						"mongos 2.2.3", null, mongos, supportedSSOO123, null);
				...
				ProductRelease mongodbconfig223 = new ProductRelease("2.2.3",
						"mongodb shard 2.2.3", null, mongodbconfig, supportedSSOO123, null);
				...
				ProductRelease contextbroker100 = new ProductRelease("1.0.0",
						"contextbroker 1.0.0", null, contextbroker, supportedSSOO123, null);
				contextbroker100 = productReleaseDao.create(contextbroker100);

			/*	ProductRelease tomcat6 = new ProductRelease("6",
						"Tomcat server 6", null, tomcat, supportedSSOO123, null);
				tomcat6 = productReleaseDao.create(tomcat6);

				ProductRelease tomcat5 = new ProductRelease("5.5",
						"Tomcat server 5.5", null, tomcat, supportedSSOO123,
			...
			//	tomcat6 = productReleaseDao.update(tomcat6);
				...
				/*ProductRelease postgres83 = new ProductRelease("8.3",
						"postgresql 8.3", null, postgresql, supportedSSOO123,
						Arrays.asList(postgres84));
			...
			/*	ProductRelease haproxy09 = new ProductRelease("0.9",
						"haproxy 0.9", null, haproxy, supportedSSOO123, null);
				haproxy09 = productReleaseDao.create(haproxy09);*/
				...
				ProductRelease test01 = new ProductRelease("0.1",
						"blah blah blah", null, test, supportedSSOO123, null);
				test01 = productReleaseDao.create(test01);

				// Wiki Product Releases
				Product mediawiki = new Product("mediawiki",
						"MediaWiki Product");
				mediawiki.addAttribute(new Attribute("wikiname",
						"Wiki to be shown", "The name of the wiki"));
				...
				ProductRelease mediawiki1 = new ProductRelease("1.17.0",
						"Mediawiki 1.17.0", null, mediawiki, supportedSSOO123,
						null);
				mediawiki1 = productReleaseDao.create(mediawiki1);

				// War Product Releases
				/*Product war = new Product("war", "War Product");
				war.addAttribute(new Attribute("warattribute", "warattribute",
						"example of war attribute"));

				war = productDao.create(war);

				ProductRelease war1 = new ProductRelease("1.0", "War 1.0",
						null, war, supportedSSOO123, null);
				war1 = productReleaseDao.create(war1);*/
			...
			/*	Environment t5Env = new Environment(Arrays.asList(tomcat5));
				...
				Environment t7_p84Env = new Environment(Arrays.asList(tomcat7,
						postgres84));
				t7_p84Env = environmentDao.create(t7_p84Env);
				Environment t7_p83Env = new Environment(Arrays.asList(tomcat7,
						postgres83));
				t7_p83Env = environmentDao.create(t7_p83Env);
				Environment t6_p84Env = new Environment(Arrays.asList(tomcat6,
						postgres84));
				t6_p84Env = environmentDao.create(t6_p84Env);
				Environment t6_p83Env = new Environment(Arrays.asList(tomcat6,
						postgres83));
				t6_p83Env = environmentDao.create(t6_p83Env);
				Environment t5_p84Env = new Environment(Arrays.asList(tomcat5,
						postgres84));
				t5_p84Env = environmentDao.create(t5_p84Env);
				Environment t5_p83Env = new Environment(Arrays.asList(tomcat5,
						postgres83));
			...
			/*	Application sdc = new Application("sdc", "this application",
				...
				// sdc.addAttribute(new Attribute("tomcat_home",
				// "/opt/apache-tomcat",
				...
				sdc.addAttribute(new Attribute("driver_class_name",
						...
						"The db driver to determine the"
								+ "concrete DB manager"));
				sdc.addAttribute(new Attribute("postgresql_url",
						"jdbc:postgresql://localhost:5432/sdc",
						"The URL wher the database is."));
				sdc.addAttribute(new Attribute("postgresql_db_user",
						"postgres", "The administrator usename"));
				sdc.addAttribute(new Attribute("postgresql_db_password",
						"postgres", "The administrator password"));
				sdc = applicationDao.create(sdc);

				ApplicationRelease sdc030 = new ApplicationRelease("1.0.0",
						"Add configuration functionallity", null, sdc,
						t6_p84Env, null);
				sdc030 = applicationReleaseDao.create(sdc030);*/

				/*
				 * ApplicationRelease sdc040 = new ApplicationRelease( "1.1.0",
				 * "Add update functionallity", null, sdc,
				 * Arrays.asList(postgres84, tomcat5), Arrays.asList(sdc030));
