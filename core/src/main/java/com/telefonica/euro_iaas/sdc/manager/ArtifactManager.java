...
public interface ArtifactManager {
	...
	ProductInstance deployArtifact(ProductInstance productInstance,
	...
	ProductInstance undeployArtifact(ProductInstance productInstance,
	 ...
	 */
	Artifact load(String vdc, String productInstance, String name)
			throws EntityNotFoundException;
	 ...
	 *             criteria
	 */
	Artifact loadByCriteria(ArtifactSearchCriteria criteria)
