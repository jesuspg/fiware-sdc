 ...
 * violated.
 * See the image bellow to know the valid and invalid transitions.
...
public interface FSMValidator {
    /**
     * Validates the transition between the actuall state of the InstallableRelease
     * and the future status.
     * @param instance
     * @param nextStatus
