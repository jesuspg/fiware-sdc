 ...
 */
public class ApplicationManagerImpl extends BaseInstallableManager implements ApplicationManager {
    ...
    public List<ApplicationRelease> findReleasesByCriteria(ApplicationReleaseSearchCriteria criteria) {
    ...
    public ApplicationRelease insert(ApplicationRelease applicationRelease, File cookbook, File installable)
        ...
        ApplicationRelease appReleaseOut = insertApplicationReleaseBBDD(applicationRelease);
    ...
    public void delete(ApplicationRelease applicationRelease) throws ApplicationReleaseNotFoundException,
    ...
    public ApplicationRelease update(ApplicationRelease applicationRelease, File cookbook, File installable)
    ...
    // **************** PRIVATE METHODS **************************//
    // ***** BBDD *****//
    private ApplicationRelease insertApplicationReleaseBBDD(ApplicationRelease applicationRelease)
            throws AlreadyExistsApplicationReleaseException, InvalidApplicationReleaseException,
            ProductReleaseNotFoundException, InvalidProductReleaseException, EnvironmentNotFoundException {
        ...
        /*
         * List<ProductRelease> productReleases = loadSupportedProductRelease ( applicationRelease);
    ...
    private void deleteApplicationReleaseBBDD(ApplicationRelease applicationRelease) {
    ...
    private boolean isLastApplicationRelease(ApplicationRelease applicationRelease)
        ...
        List<ApplicationRelease> applicationReleases = applicationReleaseDao.findByCriteria(criteria);
    ...
    private ApplicationRelease updateApplicationReleaseBBDD(ApplicationRelease applicationRelease)
            throws ApplicationReleaseNotFoundException, InvalidApplicationReleaseException,
            ProductReleaseNotFoundException, InvalidProductReleaseException, EnvironmentNotFoundException {
        ...
        /*
         * if (applicationRelease.getSupportedProducts()!=null) { List<ProductRelease> productReleases =
    ...
    private Environment loadEnvironment(ApplicationRelease applicationRelease) throws ProductReleaseNotFoundException,
        ...
        for (int i = 0; i < applicationRelease.getEnvironment().getProductReleases().size(); i++) {
            try {
                product = productDao.load(applicationRelease.getEnvironment().getProductReleases().get(i).getProduct()
                        .getName());
                productNotFoundMessage = "Product "
                        + applicationRelease.getEnvironment().getProductReleases().get(i).getProduct().getName()
                        + " LOADED";
            ...
            try {
                productRelease = productReleaseDao.load(product, applicationRelease.getEnvironment()
                        .getProductReleases().get(i).getVersion());

                LOGGER.log(Level.INFO, "ProductRelease "
                        + applicationRelease.getEnvironment().getProductReleases().get(i).getProduct().getName() + "-"
                        + applicationRelease.getEnvironment().getProductReleases().get(i).getVersion() + " LOADED");
                ...
                String productReleaseNotFoundMessage = "Product Release "
                        + applicationRelease.getEnvironment().getProductReleases().get(i).getProduct().getName() + "-"
                        + applicationRelease.getEnvironment().getProductReleases().get(i).getVersion()
                        + " has not been Found in the system";

                LOGGER.log(Level.INFO, productReleaseNotFoundMessage);
                throw new ProductReleaseNotFoundException(productReleaseNotFoundMessage, e);
            }
            environment_name = environment_name
                    + applicationRelease.getEnvironment().getProductReleases().get(i).getProduct().getName() + "-"
                    + applicationRelease.getEnvironment().getProductReleases().get(i).getVersion() + "_";
        }
        try {
            ...
            String environmentNotFoundMessage = "Environment " + environment_name + " has not been Found in the system";

            LOGGER.log(Level.INFO, environmentNotFoundMessage);
            throw new EnvironmentNotFoundException(environmentNotFoundMessage, e);
        }
    ...
    /*
     * private List<ProductRelease> loadSupportedProductRelease ( ApplicationRelease applicationRelease) throws
     * ProductReleaseNotFoundException, InvalidProductReleaseException { String productNotFoundMessage = null;
     * ProductRelease productRelease; Product product; List<ProductRelease> productReleases = new
     * ArrayList<ProductRelease>(); for (int i=0; i<applicationRelease.getSupportedProducts().size(); i++) { try {
     * product = productDao. load(applicationRelease.getSupportedProducts() .get(i).getProduct().getName());
     * productNotFoundMessage = "Product " + applicationRelease.getSupportedProducts().get(i) .getProduct().getName() +
     * " LOADED"; LOGGER.log(Level.INFO,productNotFoundMessage); } catch (EntityNotFoundException e) { throw new
     * ProductReleaseNotFoundException(productNotFoundMessage,e); } try { productRelease =
     * productReleaseDao.load(product, applicationRelease.getSupportedProducts().get(i).getVersion());
     * LOGGER.log(Level.INFO,"ProductRelease " + applicationRelease.getSupportedProducts().get(i)
     * .getProduct().getName() + "-" + applicationRelease.getSupportedProducts().get(i).getVersion() + " LOADED");
     * productReleases.add(productRelease); } catch (EntityNotFoundException e) { String productReleaseNotFoundMessage =
     * "Product Release " + applicationRelease.getSupportedProducts().get(i). getProduct().getName() + "-" +
     * applicationRelease.getSupportedProducts().get(i).getVersion() + " has not been Found in the system";
     * LOGGER.log(Level.INFO,productReleaseNotFoundMessage); throw new ProductReleaseNotFoundException (
     * productReleaseNotFoundMessage,e); } } return productReleases; } private List<ProductRelease>
     * updateApplicationReleaseLoadProductRelease (ApplicationRelease applicationRelease) throws
     * ProductReleaseNotFoundException { List<ProductRelease> productReleases = new ArrayList<ProductRelease>();
     * ProductRelease productRelease; Product product; for (int i=0; i <
     * applicationRelease.getSupportedProducts().size(); i++){ try { product = productDao.
     * load(applicationRelease.getSupportedProducts() .get(i).getProduct().getName()); LOGGER.log(Level.INFO,"Product "
     * + applicationRelease.getSupportedProducts().get(i).getProduct().getName() + " LOADED"); } catch
     * (EntityNotFoundException e) { String productReleaseNotFoundMessageLog = "Product " +
     * applicationRelease.getSupportedProducts().get(i).getProduct().getName() + " not found in the system"; throw new
     * ProductReleaseNotFoundException(productReleaseNotFoundMessageLog,e); } try { productRelease = productReleaseDao.
     * load(product, applicationRelease.getSupportedProducts().get(i).getVersion());
     * LOGGER.log(Level.INFO,"Product Release" + product.getName() + "-" +
     * applicationRelease.getSupportedProducts().get(i).getVersion() + " LOADED"); productReleases.add(productRelease);
     * } catch (EntityNotFoundException e) { String productReleaseNotFoundMessageLog = "Product " +
     * applicationRelease.getSupportedProducts().get(i).getProduct().getName() + " not found in the system"; throw new
     * ProductReleaseNotFoundException(productReleaseNotFoundMessageLog,e); } } return productReleases; }
     */

    private Application insertApplicationReleaseLoadApplication(ApplicationRelease applicationRelease)
            throws InvalidApplicationReleaseException {
        ...
        try {
            ...
            try {
                ...
                String invalidApplicationMessageLog = "The Application "
                        + applicationRelease.getApplication().getName() + " in Application Release"
                        + applicationRelease.getApplication().getName() + applicationRelease.getVersion()
                        + " is invalid. Please Insert a valid Product ";
                LOGGER.log(Level.SEVERE, invalidApplicationMessageLog);
                throw new InvalidApplicationReleaseException(invalidApplicationMessageLog, e1);
    ...
    private ApplicationRelease insertApplicationRelease(ApplicationRelease applicationRelease)
            throws InvalidApplicationReleaseException, AlreadyExistsApplicationReleaseException {

        ApplicationRelease applicationReleaseOut;

        try {
            applicationReleaseOut = applicationReleaseDao.load(applicationRelease.getApplication(),
                    applicationRelease.getVersion());
            LOGGER.log(Level.INFO, "ApplicationRelease " + applicationRelease.getApplication().getName() + "-"
            ...
            try {
                ...
                String invalidApplicationReleaseMessageLog = "The Application Release "
                        + applicationRelease.getApplication().getName() + applicationRelease.getVersion()
                        + " is invalid. Please Insert a valid Application Release";

                LOGGER.log(Level.SEVERE, invalidApplicationReleaseMessageLog);
                throw new InvalidApplicationReleaseException(invalidApplicationReleaseMessageLog, e1);
            } catch (AlreadyExistsEntityException e1) {
                LOGGER.log(Level.SEVERE, e1.getMessage());
                throw new AlreadyExistsApplicationReleaseException("The Application Release "
                        + applicationRelease.getApplication().getName() + applicationRelease.getVersion()
                        + " already exist", e1);
            }
        }
    ...
    private Application updateApplicationReleaseLoadApplication(ApplicationRelease applicationRelease)
            throws ApplicationReleaseNotFoundException {
        ...
        try {
            ...
            String entityNotFoundMessageLog = "The Application" + applicationRelease.getApplication().getName()
                    + "has not been found in the System ";

            LOGGER.log(Level.SEVERE, entityNotFoundMessageLog);
            throw new ApplicationReleaseNotFoundException(entityNotFoundMessageLog, e);
        }
        return application;
    }

    private ApplicationRelease updateApplicationRelease(ApplicationRelease applicationRelease)
            throws ApplicationReleaseNotFoundException, InvalidApplicationReleaseException {
        ...
        try {
            ...
            existedApplicationRelease = applicationReleaseDao.load(applicationRelease.getApplication(),
                    applicationRelease.getVersion());

            LOGGER.log(Level.INFO, "Application Release " + applicationRelease.getApplication().getName() + "-"
                    + applicationRelease.getVersion() + " LOADED");
            ...
            applicationReleaseOut = applicationReleaseDao.update(existedApplicationRelease);
            LOGGER.log(Level.INFO, "existedApplicationRelease " + applicationRelease.getApplication().getName() + "-"
                    + applicationRelease.getVersion() + " UPDATED");

        } catch (EntityNotFoundException e) {
            String entityNotFoundMessageLog = "The Application Release" + applicationRelease.getApplication().getName()
                    + "-" + applicationRelease.getVersion() + " has not been found in the System ";
            LOGGER.log(Level.SEVERE, entityNotFoundMessageLog);
            throw new ApplicationReleaseNotFoundException(entityNotFoundMessageLog, e);

        } catch (InvalidEntityException e) {
            String invalidEntityException = "The Application Release" + applicationRelease.getApplication().getName()
                    + " version " + applicationRelease.getVersion() + " is Invalid ";

            LOGGER.log(Level.SEVERE, invalidEntityException);
            throw new InvalidApplicationReleaseException(invalidEntityException, e);
        }
        return applicationReleaseOut;
