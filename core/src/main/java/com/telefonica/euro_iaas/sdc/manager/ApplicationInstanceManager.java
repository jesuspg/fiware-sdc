...
public interface ApplicationInstanceManager {
	 ...
	 *            the environmentInstance where the application will be
	 *            installed.
	 * @param application
	 ...
	 *             installed
	 */
	ApplicationInstance install(VM vm, String vdc,
	 ...
	 *             if the transition from the previous state to the next is not
	 *             possible
	 */
	...
	/**
	 * Upgrade an application instance form the actual version to
	 * newRelease.version.
	 * 
	 * @param applicationInstance
	 ...
	 * @throws IncompatibleProductsException
	 *             if the selected products are not compatible with the new
	 ...
	 *             if there are more than a application that match with the
	 *             given criteria
	 */
	ApplicationInstance loadByCriteria(
