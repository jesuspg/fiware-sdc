...
Feature: Add a new product in the catalogue
    As a fi-ware user
    I want to be able to retrieve the information about product
    so that I can use it.

  @happy_path
  Scenario Outline: Retrieve a product created before

    Given a created product with name "<product_name>"
    When I retrieve the product "<product_name>" with accept parameter "<accept_parameter>" response
    Then the product is retrieved
  ...
  Scenario Outline: Retrieve a product with metadata
  ...
  Scenario Outline: Retrieve a not existent product
    ...
    Given a created product with all data and name "<product_name>"
    When I retrieve the product "<another_product_name>" with accept parameter "<accept_parameter>" response
