...
Feature: Delete a product in the catalogue
    ...
    Scenario: Delete a product release in the catalogue
       Given A new product "Product_test_0001" with release "1.2.3" with description "version 1.2.3 for test" in the catalog
        When I delete a product "Product_test_0001" with release "1.2.3" in the catalog
    ...
    Scenario: Delete a product release with name very long (127 characters) in the catalogue
       Given A new product "Product_test_0001" with release "1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567" with description "version 1.2.3 for test" in the catalog
