...
Feature: Get details a product in the catalogue
    ...
    Scenario: Get details of a product release in the catalogue with xml content in the response
       Given I add a new release "1.2.3" with description "version for test" associated to product "Product_test_0001" in the catalog with "xml" content in the response
        When I get details of release "1.2.3" associated to a product "Product_test_0001" in the catalog with "xml" content in the response
    ...
    Scenario: Get details of a product release in the catalogue with json content in the response
       Given I add a new release "1.2.3" with description "version for test" associated to product "Product_test_0001" in the catalog with "json" content in the response
        When I get details of release "1.2.3" associated to a product "Product_test_0001" in the catalog with "json" content in the response
    ...
    Scenario: Try to get details of a non-existent product release in the catalogue
       Given I add a new release "1.2.3" with description "version for test" associated to product "Product_test_0001" in the catalog with "json" content in the response
        When I get details of release "1.2.3.4.5.6" associated to a product "Product_test_0001" in the catalog with "json" content in the response
        Then I receive an "Not Found" response with a "Product releases details JSON" with "1.2.3" with "Any" content
