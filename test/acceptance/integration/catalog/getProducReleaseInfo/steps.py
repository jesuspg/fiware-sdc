...
#------------------------------------- getProductList ----------------------------------------------
@step(u'I request releases list associated to a product "([^"]*)" in the catalog')
def i_request_releases_list_associated_to_a_product_in_the_catalog(step, product):
    world.env_requests.catalogue_getProductReleaseInfo("getProductReleaseList", product, NOT_ERROR)
