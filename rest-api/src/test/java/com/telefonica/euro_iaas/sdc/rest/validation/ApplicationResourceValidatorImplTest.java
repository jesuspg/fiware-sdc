...
public class ApplicationResourceValidatorImplTest extends ValidatorUtils {
    ...
    public void testUpdateValidateKO() throws Exception {
        /*
         * File recipes = createTempFile ("recipes"); File installable = createTempFile ("installable"); byte[]
         * bytesRecipes = getByteFromFile(recipes); byte[] bytesInstallable = getByteFromFile (installable);
         * deleteFile(recipes); deleteFile(installable); System.out.println("AplictionreleaseDto " +
         * applicationReleaseDto.getApplicationName()); MultiPart multiPart = new MultiPart().bodyPart(new BodyPart(
         * applicationReleaseDto,MediaType.APPLICATION_XML_TYPE)) .bodyPart(new BodyPart(bytesRecipes,
         * MediaType.APPLICATION_OCTET_STREAM_TYPE)) .bodyPart(new BodyPart(bytesInstallable,
    ...
    public void testUpdateValidateOK() throws Exception {
        ...
        MultiPart multiPart = new MultiPart()
                .bodyPart(new BodyPart(applicationReleaseDto, MediaType.APPLICATION_JSON_TYPE))
