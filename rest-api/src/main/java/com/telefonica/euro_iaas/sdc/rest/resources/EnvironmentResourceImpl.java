...
public class EnvironmentResourceImpl implements EnvironmentResource {
	...
	/*
	 * @InjectParam("environmentManager") private EnvironmentManager
	 * environmentManager;
	 * 
	 * 
	 * @Override public Environment insert(EnvironmentDto environmentDto) throws
	 ...
	 * 
	 * for (int i=0; i < productReleaseDtos.size(); i++) { ProductReleaseDto
	 * productReleaseDto = productReleaseDtos.get(i); Product product = new
	 * Product ( productReleaseDto.getProductName(),
	 ...
	 * productReleaseDto.getVersion(), productReleaseDto.getReleaseNotes(),
	 ...
	 * 
	 * 
	 * @Override public List<Environment> findAll(Integer page, Integer
	 * pageSize, String orderBy, String orderType) {
	 * 
	 * EnvironmentSearchCriteria criteria = new EnvironmentSearchCriteria(); if
	 * (page != null && pageSize != null) { criteria.setPage(page);
	 * criteria.setPageSize(pageSize); } if (!StringUtils.isEmpty(orderBy)) {
	 * criteria.setOrderBy(orderBy); } if (!StringUtils.isEmpty(orderType)) {
	 * criteria.setOrderBy(orderType); } return
	 * environmentManager.findByCriteria(criteria); }
	 * 
	 * 
	 * @Override public Environment load(String name) throws
	 * EnvironmentNotFoundException { return environmentManager.load(name); }
	 */
	 ...
	 */
	/*
	 * @Override public void delete (String envName) throws
	 ...
	 */
	/*
	 * @Override public Environment update(EnvironmentDto environmentDto) throws
	 ...
	 * productReleaseDtosToBeUpdated.get(i); Product product = new Product (
