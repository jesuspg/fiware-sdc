...
public interface EnvironmentResource {
	 ...
	 * Environment insert(EnvironmentDto environmentDto) throws
	 ...
	 * 
	 * @Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	 * Environment load(@PathParam("envName") String name) throws
	 ...
	 * 
	 * @Consumes( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	 * void delete(@PathParam("envName") String envName) throws
