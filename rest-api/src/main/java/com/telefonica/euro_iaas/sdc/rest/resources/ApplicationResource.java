...
public interface ApplicationResource {
     ...
     * @param The
     *            set of installables requires fot the application to install/ /uninstall the product
     ...
     *             if the Application Release is invalid due to either OS, Product or Product Release
     * @throws ProductReleaseNotFoundException
     *             if any of the productRelease the Application release depends on is not found
    ...
    ApplicationRelease insert(MultiPart multiPart) throws AlreadyExistsApplicationReleaseException,
    ...
    @Path("/")
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    List<Application> findAll(@QueryParam("page") Integer page, @QueryParam("pageSize") Integer pageSize,
    ...
    @Path("/{appName}")
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    Application load(@PathParam("appName") String name) throws EntityNotFoundException;
    ...
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    List<Attribute> loadAttributes(@PathParam("appName") String name) throws EntityNotFoundException;
    ...
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    List<ApplicationRelease> findAll(@PathParam("appName") String name, @QueryParam("page") Integer page,
    ...
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    ApplicationRelease load(@PathParam("appName") String name, @PathParam("version") String version)
            throws EntityNotFoundException;
    ...
    @DELETE
    @Path("/{appName}/release/{version}")
    void delete(@PathParam("appName") String name, @PathParam("version") String version)
            throws ApplicationReleaseNotFoundException, ApplicationReleaseStillInstalledException;
     ...
     *            cookbook in a tar file
     * @param The
     *            set of installables requires for the application to install/ /uninstall the product
     * @return the application release.
     * @throws ApplicationReleaseNotFoundException
     *             if the application Release does not exists
     * @throws InvalidApplicationReleaseException
    ...
    @Path("/{appName}/release/{version}")
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    ApplicationRelease update(MultiPart multipart) throws ApplicationReleaseNotFoundException,
    ...
    /**
     * Retrieve the attributes for the selected application release. The result is a merge between common attributes (of
     * the application) and the private attributes of the concrete release.
     * 
     * @param name
     *            the application name
     * @param version
    ...
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    List<Attribute> loadAttributes(@PathParam("appName") String name, @PathParam("version") String version)
            throws EntityNotFoundException;

    /**
     * Find all possible transitions for a concrete release. It means, the different version of a application which are
    ...
    @Produces({ MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    List<ApplicationRelease> findTransitable(@PathParam("appName") String name, @PathParam("version") String version)
            throws EntityNotFoundException;
