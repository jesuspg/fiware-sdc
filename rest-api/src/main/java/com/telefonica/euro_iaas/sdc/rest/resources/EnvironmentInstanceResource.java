...
public interface EnvironmentInstanceResource {
	...
	/**
	 * Add the selected EnvironmentInstance in to the SDC's catalog. If the
	 * Environment already exists, then add the new Release.
	 * 
	 * @param EnvironmentInstanceDto
	 *            <ol>
	 *            <li>The EnvironmentInstanceDto: contains the information about
	 *            the product</li>
	 *            </ol>
	 ...
	 * 
	 * @Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	 * EnvironmentInstance load(@PathParam("Id") Long Id) throws
	 ...
	 * 
	 * @Consumes( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	 * void delete(@PathParam("Id") Long Id) throws
	 * EnvironmentInstanceNotFoundException,
	 ...
	 * @throwsEnvironmentInstanceNotFoundException if the EnvironmentInstance
	 *                                             does not exists
