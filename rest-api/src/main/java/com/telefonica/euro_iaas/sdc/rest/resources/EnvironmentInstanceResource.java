...
public interface EnvironmentInstanceResource {
    ...
    /**
     * Add the selected EnvironmentInstance in to the SDC's catalog. 
     * If the Environment
     ...
     * @throws AlreadyExistsProductInstanceException if the Product Release exists
     * @throws InvalidProductInstanceException if the Product Instance is invalid
     * @throws  EnvironmentNotFoundException id Environment is not in BBDD
     * @throws  ProductInstanceNotFoundException if ProductInstance is not in BBDD
     *
     */
    @POST
    @Path("/")
    ...
    @Path("/")
    @Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    List<EnvironmentInstance> findAll(@QueryParam("page") Integer page,
    ...
    @Path("/{Id}")
    @Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
    EnvironmentInstance load(@PathParam("Id") Long Id)
        throws EnvironmentInstanceNotFoundException;
    
    /**
     * Delete the EnvironmentInstance in BBDD, 
     * @param name  the env name
     * @throws EnvironmentInstanceNotFoundException if the EnvironmentInstance 
     * does not exists
     ...
     * @throwsEnvironmentInstanceNotFoundException
     ...
     *  @throws EnvironmentNotFoundException if the Environment is not in BBDD
     *  @throws ProductInstanceNotFoundException if any ProdutInstance is not
     *  in BBDD
     */
