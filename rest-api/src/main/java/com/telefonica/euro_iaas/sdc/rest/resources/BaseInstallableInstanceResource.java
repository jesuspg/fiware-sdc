...
public interface BaseInstallableInstanceResource {
	 ...
	 * upgrade(@PathParam("vdc") String vdc, @PathParam("id") Long id,
	 * 
	...
	Task upgrade(@PathParam("vdc") String vdc, @PathParam("name") String name,
			@PathParam("newVersion") String version,
			@HeaderParam("callback") String callback);
	...
	@Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	@Consumes( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	Task configure(@PathParam("vdc") String vdc,
	...
	@Path("/{name}")
	@Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	Task uninstall(@PathParam("vdc") String vdc,
			@PathParam("name") String name,
			@HeaderParam("callback") String callback);
