...
public class ApplicationResourceImpl implements ApplicationResource {
     ...
     */
    @Override
    public ApplicationRelease insert(MultiPart multiPart) throws AlreadyExistsApplicationReleaseException,
            InvalidApplicationReleaseException, ProductReleaseNotFoundException, InvalidMultiPartRequestException,
        ...
        ApplicationReleaseDto applicationReleaseDto = (ApplicationReleaseDto) multiPart.getBodyParts().get(0)
                .getEntityAs(ApplicationReleaseDto.class);
        LOGGER.log(Level.INFO, " Insert ApplicationRelease " + applicationReleaseDto.getApplicationName() + " version "
                + applicationReleaseDto.getVersion());

        Application application = new Application(applicationReleaseDto.getApplicationName(),
                applicationReleaseDto.getApplicationDescription(), applicationReleaseDto.getApplicationType());
        ...
        for (int i = 0; i < productReleaseDtos.size(); i++) {
            ...
            productRelease.setProduct(new Product(productReleaseDtos.get(i).getProductName(), productReleaseDtos.get(i)
        ...
        ApplicationRelease applicationRelease = new ApplicationRelease(applicationReleaseDto.getVersion(),
                applicationReleaseDto.getReleaseNotes(), applicationReleaseDto.getPrivateAttributes(), application,
                new Environment(productReleases), applicationReleaseDto.getTransitableReleases());

        try {
            cookbook = File.createTempFile("cookbook-" + applicationReleaseDto.getApplicationName() + "-"
                    + applicationReleaseDto.getVersion() + ".tar", ".tmp");

            installable = File.createTempFile("installable-" + applicationReleaseDto.getApplicationName() + "-"
                    + applicationReleaseDto.getVersion() + ".tar", ".tmp");
        ...
        return applicationManager.insert(applicationRelease, cookbook, installable);
    }
     ...
     */
    @Override
    public List<Application> findAll(Integer page, Integer pageSize, String orderBy, String orderType) {
     ...
     */
    @Override
    public List<ApplicationRelease> findAll(String name, Integer page, Integer pageSize, String orderBy,
            String orderType) {
     ...
     */
    @Override
    public ApplicationRelease load(String name, String version) throws EntityNotFoundException {
        Application application = applicationManager.load(name);
     ...
     */
    @Override
    public void delete(String name, String version) throws ApplicationReleaseNotFoundException,
            ApplicationReleaseStillInstalledException {

        LOGGER.log(Level.INFO, "Delete ApplicationRelease. ApplicationName : " + name + " ApplicationVersion : "
                + version);
     ...
     */
    @Override
    public ApplicationRelease update(MultiPart multiPart) throws ApplicationReleaseNotFoundException,
            InvalidApplicationReleaseException, ProductReleaseNotFoundException,
            InvalidApplicationReleaseUpdateRequestException, InvalidMultiPartRequestException,
            InvalidProductReleaseException, EnvironmentNotFoundException {

        ApplicationReleaseDto applicationReleaseDto = (ApplicationReleaseDto) multiPart.getBodyParts().get(0)
                .getEntityAs(ApplicationReleaseDto.class);

        LOGGER.log(Level.INFO, " Update ApplicationRelease " + applicationReleaseDto.getApplicationName() + " version "
                + applicationReleaseDto.getVersion());
        ...
        if (applicationReleaseDto.getEnvironmentDto() != null) {
            ...
            for (int i = 0; i < productReleaseDtos.size(); i++) {
                ProductRelease productRelease = new ProductRelease();
                productRelease.setProduct(new Product(productReleaseDtos.get(i).getProductName(), productReleaseDtos
                        .get(i).getProductDescription()));
                productRelease.setPrivateAttributes(productReleaseDtos.get(i).getPrivateAttributes());
                productRelease.setReleaseNotes(productReleaseDtos.get(i).getReleaseNotes());
                productRelease.setSupportedOOSS(productReleaseDtos.get(i).getSupportedOS());
                productRelease.setTransitableReleases(productReleaseDtos.get(i).getTransitableReleases());
     ...
     */
    @Override
    public List<ApplicationRelease> findTransitable(String name, String version) throws EntityNotFoundException {
    ...
    @Override
    public List<ApplicationRelease> findAllReleases(Integer page, Integer pageSize, String orderBy, String orderType) {
        ApplicationReleaseSearchCriteria criteria = new ApplicationReleaseSearchCriteria();
        if (page != null && pageSize != null) {
            criteria.setPage(page);
            criteria.setPageSize(pageSize);
