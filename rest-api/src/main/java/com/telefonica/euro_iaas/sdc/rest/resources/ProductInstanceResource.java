 ...
 * 
 */
public interface ProductInstanceResource extends
		BaseInstallableInstanceResource {
	...
	@Path("/{name}")
	@Produces( { MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON })
	ProductInstance load(@PathParam("vdc") String vdc,
	 ...
	 * deployArtifact(@PathParam("vdc") String vdc, @PathParam("name") String
	 * name,
	 * 
