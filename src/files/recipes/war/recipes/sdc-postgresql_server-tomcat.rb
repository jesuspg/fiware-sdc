...
#  command "/opt/sdc/app/war/sdc/install/sdc-pre.sh"
#  action :run
#end
...
script "sdc-pre" do
  ...
  cwd "/tmp"
  code <<-EOH
  /opt/sdc/app/war/sdc/install/sdc-pre.sh
  EOH
end
...
script "sdc-postgres" do
  ...
  cwd "/tmp"
  code <<-EOH
  /opt/sdc/app/war/sdc/install/sdc-postgres.sh
  EOH
end
...
script "sdc-post" do
  ...
  cwd "/tmp"
  code <<-EOH
  /opt/sdc/app/war/sdc/install/sdc-post.sh
  EOH
end
