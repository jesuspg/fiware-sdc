...
public class ProductSteps {
    ...
    public void getProduct(String productName, String version)  
    	throws Exception {
    	System.out.println ("product: " +  "version: " + version);
    	ProductUtils manager = new ProductUtils();
    	existedProduct = manager.load(productName, version);  
    	System.out.println ("existed product: " + existedProduct.getProduct().getName() +
    			"version: " + existedProduct.getVersion());
    }
    
    @When("^I update \"([^\"]*)\" \"([^\"]*)\" \\(\"([^\"]*)\"\\)$")
    public void updateProductToCatalog(String productName, String version, String description)
    throws Exception {
        ProductUtils manager = new ProductUtils();
