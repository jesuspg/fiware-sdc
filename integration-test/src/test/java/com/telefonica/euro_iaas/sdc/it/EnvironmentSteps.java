...
public class EnvironmentSteps {
    ...
    public void getEnvironment(String envName, String envDesc)  
    	throws Exception {
    	EnvironmentUtils manager = new EnvironmentUtils();
    	existedEnvironment = manager.load(envName);
    	System.out.println ("existed Environment: " 
    			+ existedEnvironment.getName() +
    			" wth description: " + existedEnvironment.getDescription());
    }
    ...
    throws Exception {
        ...
        System.out.println ("Updted Environment: " 
    			+ updatedEnvironment.getName() +
    			" wth description: " + updatedEnvironment.getDescription());
    }
    ...
    public void assertUpdatedEnvironment(String envName) {
        ...
        Assert.assertEquals(updatedEnvironment.getName(), 
        		existedEnvironment.getName());
    ...
    public void getProductFromCatalog(String envName)  
    	throws Exception {
    ...
    public void deleteProductToCatalog(String envName)
    throws Exception {
    	EnvironmentUtils manager = new EnvironmentUtils();
