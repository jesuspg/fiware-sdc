...
public class ApplicationSteps {
	...
	public void addApplicationToCatalog(String applicationName, String version,
		...
		ApplicationUtils manager = new ApplicationUtils();
		addedApplication = manager.add(applicationName, version, type,
				description, "", attributes, environmentDto,
				transitableReleases);
	}
	...
	public void updateApplicationToCatalog(String applicationName,
		...
		ApplicationUtils manager = new ApplicationUtils();
		updatedApplication = manager.update(applicationName, version, type,
				description, "", attributes, environmentDto,
				transitableReleases);
	}
	...
	public void getApplicationFromCatalog(String applicationName, String version)
			throws Exception {
		System.out.println("application: " + applicationName + "version: "
				+ version);
		ApplicationUtils manager = new ApplicationUtils();
		existedApplication = manager.load(applicationName, version);
		System.out.println("existed application: "
				+ existedApplication.getApplication().getName() + "version: "
				+ existedApplication.getVersion());
	}

	@When("^I delete application \"([^\"]*)\" \"([^\"]*)\"$")
	public void deleteApplicationFromCatalog(String applicationName,
