...
public class ProductInstanceTest extends TestCase {
    ...
    public void testProductRelease() {
        ...
        ApplicationRelease appRelease = new ApplicationRelease("version", "releaseNotes", null, application, env1, null);

        EnvironmentInstance envInstance = new EnvironmentInstance(env1, products);
        ApplicationInstance applicationInstance = new ApplicationInstance(appRelease, envInstance, Status.INSTALLED,
                vm, "vdc");
