...
public class ChefClientTest extends TestCase{
	...
	public void testGetChefClientURL() throws Exception {
		String name = chefClient.getChefClientName(json, "henartmactmysqlInstance2-tomcat7postgres8Tier-1");
		assertEquals(name, "henartmactmysqlInstance2-tomcat7postgres8Tier-1.novalocal");
	}
