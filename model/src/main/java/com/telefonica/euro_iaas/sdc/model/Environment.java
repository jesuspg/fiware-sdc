...
/**
 * Represents a set of ProductReleases over which an application release can can be installed
 * 
...
public class Environment {
    ...
    private String getNameFromProductReleaseList(List<ProductRelease> productReleases) {
        ...
        for (ProductRelease productRelease : productReleases) {
            name = name + productRelease.getProduct().getName() + "-" + productRelease.getVersion() + "_";
        }
        return name;
    }
