...
public class ApplicationRelease extends InstallableRelease {
     ...
     */
    public ApplicationRelease(String version, String releaseNotes, List<Attribute> privateAttributes,
            Application application, Environment environment, List<ApplicationRelease> applicationReleases) {
